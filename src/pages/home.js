...
const Home = () => {
  ...
  return (
    <div className='Home'>
      ...
      <Container fluid="sm">
        <div className='text-center'>
          <h1 className='text-6xl text-center font-bold mb-4 pt-32'>got deliver <br />everything you need.</h1>
      ...
      {/* <button className={`bg-[#3498db] p-[10px] text-[white] rounded-md hover:bg-[red] hover:text-[#3498db]`} onClick={()=>{changeDir(ROUTES.About)}}>Go To About</button> */}
       ...
       <Container fluid="sm">
          ...
          <h3 className='text-xl text-center font-regular text-white w-6/12 m-auto pb-12 tracking-wide'>Let go off your hectic grocery shopping. Now order groceries with us and save time with our quick delivery services.</h3>
        </Container>
       </section>
       ...
       <Container fluid="sm">
          ...
          <h3 className='text-xl text-center font-regular text-white w-6/12 m-auto mb-2 tracking-wide'>When you do not feel well.Order Medicines with quick delivery & hassle free experience.</h3>
          <p className='text-md text-center font-regular text-white w-6/12 m-auto pb-12 tracking-wide'>(You can upload your prescription)</p>
        </Container>
       </section>
    ...
    <div className="px-4 py-8  text-center">
      <h5 className="text-2xl text-black-500 font-bold mb-4 text-center">Choose what you want</h5>
    ...
    <div className="px-4 py-8  text-center">
      <h5 className="text-2xl text-black-500 font-bold  mb-4 text-center">See real-time updates</h5>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis, rem.</p>
    </div>
  </div>
          </Col>
    ...
    <div className="px-4 py-8 text-center">
      <h5 className="text-2xl text-black-500 font-bold  mb-4 text-center">Get you items same-day</h5>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis, rem.</p>
    </div>
  </div>
          </Col>
